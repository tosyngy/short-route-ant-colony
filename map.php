<html>
    ...
    include 'db.php';
    if (isset($_POST["save"])) {
        $h_block = $_POST["avoid_highways"];
        $from = $_POST["start"];
        $to = $_POST["to"];
        $v_rate = $_POST["population_size"];
        $c_rate = $_POST["crossing_rate"];
        $delay = $_POST["delay_rate"];
        $f_log=0;
        $t_log=0;
        $f_lat=0;
        $t_lat=0;
        $query = "INSERT INTO road_update (from_location,to_location,from_log,from_lat,to_log,to_lat,highway_block,vehicle_rate,cross_rate,delay,status)
            VALUES('" . $from . "','" . $to . "','" . $f_log . "','" . $f_lat . "','" . $t_log . "','" . $t_lat . "','" . $h_block . "','" . $v_rate . "','" . $c_rate . "','" . $delay . "','0')";
        echo $query;
       $excutequery = mysqli_query($link,$query);
        if ($executeQuery) {
            echo"<script> alert('Save successfully')</script>";
        }else{
             echo"<script> alert('Database Error: Check your input')</script>";
        }
    }
    ?> 
    ...
    <body>
        <div class="container">
            <div style="width: 100%">
                <div id="map-canvas" style="margin: auto;width:100%;height: 90%"></div>
                ...
                <div>
                    ...
                    <table>
                        <form method="post" action="">
                            ...
                            <tr>
                                <td colspan="2" style="font-size: 30px; text-align: center"><b style="color: #4485f2">Configuration</b></td>
                            </tr>
 <tr>
                                <td>Start Location: </td>
                                <td>
                                    <input type="text" name="start" required="" id="autocompelte">
                                </td>
                            </tr>
                            <tr>
                                <td>To Location: </td>
                            ...
                            <tr>
                                <td>Highways Blocked: </td>
                                <td>
                                    <select id="avoid-highways" name="avoid_highways" required="">
                            ...
                            <tr>
                                <td>Vehicle Rate/sec </td>
                                <td>
                                    <select id="population-size" name="population_size" required="">
                            ...
                            <tr>
                                <td>Vehicle Crossing Threshold: </td>
                                <td>
                                    <select id="crossover-rate" name="crossover_rate" required="">
                            ...
                            <tr>
                                <td>Delay Rate: </td>
                                <td>
                                    <input type="text" name="delay_rate"  placeholder="value in minute approximation">
                                </td>
                            </tr>
                            <tr id="ga-buttons">
                                <td colspan="2"><button  type="submit" name="save">Start</button> <button id="clear-map">Clear</button></td>
                            </tr>
                    </table
                    </form>
                </div>
